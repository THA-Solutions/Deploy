...
//Define as variaveis de estado
  const handleAdd = async (data,e) => {
    ...
    const imagemProduto= await fetch('https://api.cloudinary.com/v1_1/dbnjz7ugi/image/upload', {
      method: 'POST',
      body: formData
    }).then(r => r.json());
    ...
    const produto= await axios.post(`${BASE_URL}/api/dashboard/createProduct`,data)
  ...
  const divisaoBebidas=[
    "Água Mineral",
    "Energético",
    "Refrigerante",
  ]//Define as categorias de bebidas
  ...
  function selectCategory(event) {
   ...
   ( reset(),
   setValue("divisao", value),setDivisao(value),
      value==="Solar" ? setCategoria("Inversor On-Grid") : setCategoria("Água Mineral"),
   setValue("categoria", categoria),setValue("titulo_produto",titulo),setValue("marca_produto",marca)
   ) : divisaoSolar.includes(value) ?
    (setCategoria(value),
     reset(),
     setValue("categoria", categoria),
     setDivisao("Solar"),setValue("divisao",divisao),
     setValue("titulo_produto",titulo),setValue("marca_produto",marca)
     ) : 
    (
    setCategoria(value),
    setValue("categoria", categoria),
    setValue("titulo_produto",titulo),setValue("marca_produto",marca),
    setDivisao("Bebidas"),setValue("divisao",divisao))
    ...
    <section>
        ...
        <form onSubmit={handleSubmit(handleAdd)} className={styles.formClass}>
          ...
          {errors?.titulo_produto?.type === "required" && (
                <span className={style.error_message}>Insira um Titulo para o Produto</span>
              )}
          <input
            id="marca_produto"
            type="marca_produto"
          ...
          {errors?.marca_produto?.type === "required" && (
                <span className={style.error_message}>Associe este produto a uma Marca</span>
              )}
          {}
    ...
    {divisao === "Solar" ? (
      ...
      <option value="Bebidas">Bebidas</option>
          ...
          {errors?.categoria?.type === "required" && (
                <span className={style.error_message}>Associe este Produto a uma Categoria</span>
              )}
          <input
            id="modelo"
            type="modelo"
          ...
          {errors?.modelo?.type === "required" && (
                <span className={style.error_message}>Informe o modelo deste produto</span>
              )}
          <input
            id="descricao"
            type="descricao"
          ...
          />
          {errors?.modelo?.type === "required" && (
                <span className={style.error_message}>Informe a quantidade deste produto em estoque</span>
              )}     
          {/**_______________________________________________________________________________________*/}  
          <input type="file" name="file" id="fileInput" onChange={(e)=>{setFile(e.target.files[0])}} />
          {/**___________________________________Upload dos arquivos ________________________________*/}  
          {file ?(console.log(file,'file'),<Image
          ...
          {errors?.preco?.type === "required" && (
                <span className={style.error_message}>Informe o preço deste produto</span>
              )}
          ...
          {errors?.altura?.type === "required" && (
                <span className={style.error_message}>Informe a altura do produto</span>
              )}
          <input
            id="largura"
            type="largura"
          ...
          {errors?.largura?.type === "required" && (
                <span className={style.error_message}>Informe a largura do produto</span>
              )}
          <input
            id="comprimento"
            type="comprimento"
          ...
          {errors?.comprimento?.type === "required" && (
                <span className={style.error_message}>Informe o comprimento do produto</span>
              )}
         ...
         <>
          ...
          />
            {errors?.potencia_entrada?.type === "required" && (
                <span className={style.error_message}>Informe a potencia de entrada</span>
              )}
          <input
            id="potencia_saida"
            type="potencia_saida"
          ...
          />
            {errors?.potencia_saida?.type === "required" && (
                <span className={style.error_message}>Informe a potencia de saida</span>
              )}
          <input
            id="corrente_entrada"
          ...
          />
            {errors?.corrente_entrada?.type === "required" && (
                <span className={style.error_message}>Informe a corrente de entrada</span>
              )}
          <input
            id="corrente_entrada"
            type="corrente_saida"
          ...
          />
            {errors?.corrente_saida?.type === "required" && ( 
                <span className={style.error_message}>Informe a corrente de saida</span>
              )}
          <input
            id="quantidade_mppt"
          ...
          />
            {errors?.quantidade_mppt?.type === "required" && (  
                <span className={style.error_message}>Informe a quantidade de MPPTs</span>
              )}
          </> 
          //Fim Inversor
        ...
        {errors?.eficiencia?.type === "required" && (
                <span className={style.error_message}>Informe a eficiencia do painel</span>
              )}
        <input
          id="eficiencia"
          type="eficiencia"
        ...
        {errors?.tipo_celula?.type === "required" && (
                <span className={style.error_message}>Informe o tipo de célula</span>
              )}
        <input
          id="potencia_modulo"
        ...
        {errors?.potencia_modulo?.type === "required" && (
                <span className={style.error_message}>Informe a potência do modulo</span> 
              )}
        <input
        ...
        {errors?.tensao_circuitoaberto?.type === "required" && (
                <span className={style.error_message}>Informe a tensão de circuito aberto</span>  
              )}
        <input
          id="tensao_potencia"
        ...
        {errors?.tensao_potencia?.type === "required" && (  
                <span className={style.error_message}>Informe a tensão de potência</span>
              )}
        <input
          id="tensao_sistema"
          type="tensao_sistema"
        ...
        {errors?.tensao_sistema?.type === "required" && (
                <span className={style.error_message}>Informe a tensão do sistema</span>
              )}
        <input
          id="corrente_curto"
          type="corrente_curto"
        ...
        {errors?.corrente_curto?.type === "required" && (
                <span className={style.error_message}>Informe a corrente de curto</span>
              )}
        <input
          id="corrente_fusivel"
        ...
        {errors?.corrente_fusivel?.type === "required" && (
                <span className={style.error_message}>Informe a corrente de fusivel</span>
              )}
        ...
        {errors?.alcance?.type === "required" && (
                <span className={style.error_message}>Informe o alcance suportado</span>
              )}
        <input
          id="tensao_operacao"
        ...
        {errors?.tensao_operacao?.type === "required" && (
                <span className={style.error_message}>Informe a tensão de operação</span>
              )}
        <input
          id="consumo"
          type="consumo"
        ...
        {errors?.conexao?.type === "required" && (
                <span className={style.error_message}>Informe o tipo de conexão</span>
              )}
        <input
          id="tensao_entrada"
          type="tensao_entrada"
        ...
        {errors?.tensao_entrada?.type === "required" && (
                <span className={style.error_message}>Informe a tensão de entrada</span>
              )}
        <input
          id="polos"
          type="polos"
        ...
        {errors?.tensao_mppt?.type === "required" && (
                <span className={style.error_message}>Informe a tensão maxima por MPPT</span>
              )}
        <input
          id="tensao_saida"
          type="tensao_saida"
        ...
        {errors?.tensao_saida?.type === "required" && (
                <span className={style.error_message}>Informe a tensão de saida</span>
              )}
        <input
          id="corrente_curto"
          type="corrente_curto"
        ...
        {errors?.corrente_mppt?.type === "required" && (
                <span className={style.error_message}>Informe a corrente maxima por MPPT</span>
              )}
        <input
          id="corrente_saida"
          type="corrente_saida"
        ...
        {errors?.quantidade_mppt?.type === "required" && (
          ...
          //Fim Microinversor
        ): /^Energético/.test(categoria) ||/^Água Mineral/.test(categoria) || /^Refrigerante/.test(categoria) ? (
          <>
          <input
          id="volume"
          type="volume"
        ...
        {errors?.qtde_fardo?.type === "required" && (
                <span className={style.error_message}>Informe a quantidade por fardo</span>
              )}
          </>
        ): NULL
        }
